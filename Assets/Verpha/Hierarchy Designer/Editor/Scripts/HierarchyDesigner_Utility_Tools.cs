...
namespace Verpha.HierarchyDesigner
{
    public static class HierarchyDesigner_Utility_Tools
    {
        ...
        [MenuItem(MenuPath + "Renaming/Rename Selected GameObjects With Same Name", false, priorityBase + 12)]
        [HierarchyDesigner_Tool(HierarchyDesigner_ToolCategory.Renaming)]
        ...
        public static void SortAlphabeticallyAscending() => SortSelectedGameObjectChildren((a, b) => a.name.CompareTo(b.name), "sort its children alphabetically ascending");

        [MenuItem(MenuPath + "Sorting/Sort Alphabetically Descending", false, priorityBase + 14)]
        [HierarchyDesigner_Tool(HierarchyDesigner_ToolCategory.Sorting)]
        public static void SortAlphabeticallyDescending() => SortSelectedGameObjectChildren((a, b) => b.name.CompareTo(a.name), "sort its children alphabetically descending");
